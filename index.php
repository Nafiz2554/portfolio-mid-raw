...
<body>
  ...
  <section id="contact">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "INSERT INTO `information` VALUES ('$firstName','$lastName','$address','$email','$message')";
      if ($conn->query($sql) === TRUE) {

        echo "<h2 style='color:#ff002f;text-shadow:3px 0px 2px darkslategrey;font-weight: bold;padding-bottom:15px;text-align:center;'>Message sent successfully</h2>";
      } else {
